...
export const useSEO = (config: SEOConfig) => {
  ...
  useEffect(() => {
    ...
    const {
      ...
      description = isRTL 
        ? 'تطبيق QiyasaT الشامل لحساب السعرات الحرارية، تتبع قياسات الجسم، تحويل السعرات لدقائق التمارين، وحساب احتياجات الماء اليومية'
      ...
      keywords = isRTL
        ? 'حاسبة السعرات الحرارية، قياسات الجسم، تمارين رياضية، حاسبة الماء، صحة ولياقة، QiyasaT، تطبيق صحة عربي'
...
export const SEO_CONFIGS = {
  ...
  calories: {
    title: 'حاسبة السعرات الحرارية | احسب احتياجك اليومي - QiyasaT',
  ...
  measurements: {
    title: 'تتبع قياسات الجسم | قياس التقدم والنتائج - QiyasaT',
  ...
  cardio: {
    title: 'محول الكارديو | حول السعرات لدقائق تمارين - QiyasaT',
  ...
  water: {
    title: 'حاسبة الماء | احسب احتياجك اليومي من الماء - QiyasaT',
  ...
  program: {
    title: 'البرنامج الأسبوعي للتمارين | خطط تمارينك - QiyasaT',
  ...
  wakeup: {
    title: 'تحدي الاستيقاظ المبكر | طور عادات صحية - QiyasaT',
  ...
  items: {
    title: 'أغراضي | تنظيم متعلقاتك الصحية - QiyasaT',
  ...
  terms: {
    title: 'الشروط والخصوصية | سياسة الاستخدام - QiyasaT',
    description: 'اطلع على شروط الاستخدام وسياسة الخصوصية لتطبيق QiyasaT. معلومات مفصلة حول حماية بياناتك وحقوقك عند استخدام التطبيق.',
