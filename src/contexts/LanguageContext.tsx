...
const translations = {
  ar: {
    ...
    acceptanceOfTermsText: 'باستخدام تطبيق "صحتي"، فإنك توافق على الالتزام بجميع الشروط والأحكام المذكورة هنا. إذا كنت لا توافق على أي من هذه الشروط، يرجى عدم استخدام التطبيق.',
    serviceDescription: 'وصف الخدمة',
    serviceDescriptionText: 'تطبيق "صحتي" هو أداة مساعدة لتتبع الصحة واللياقة البدنية تتضمن حاسبة السعرات الحرارية، قياسات الجسم، محول الكارديو، البرامج الأسبوعية، وتتبع الأغراض الرياضية.',
