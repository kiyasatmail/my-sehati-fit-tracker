...
const buttonVariants = cva(
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-lg text-sm font-medium transition-smooth focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-ring focus-visible:ring-offset-2 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg]:size-4 [&_svg]:shrink-0",
  {
    variants: {
      variant: {
        default: "bg-primary text-primary-foreground hover:bg-primary-light shadow-button hover:shadow-lg transform hover:-translate-y-0.5 transition-bounce",
        destructive:
        ...
        hero: "gradient-hero text-primary-foreground shadow-hero hover:shadow-xl transform hover:-translate-y-1 transition-bounce border-0",
        success: "bg-success text-white hover:bg-success/90 shadow-button",
        warning: "bg-warning text-white hover:bg-warning/90 shadow-button",
      },
      size: {
